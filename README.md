...
```javascript
import str2enum from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dtype-str2enum@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/strided-base-dtype-str2enum/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/strided-base-dtype-str2enum/actions/workflows/test.yml?query=branch:v0.2.1
